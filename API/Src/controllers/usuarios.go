...
// BuscarUsuarios busca todos usuarios do banco
...
// BuscaUsuario busca um usuario no banco
...
// AtualizarUsuario atualiza as informações no banco
func AtualizarUsuario(w http.ResponseWriter, r *http.Request) {
	...
	var usuario modelos.Usuario
	if erro = json.Unmarshal(corpoRquisicao, &usuario); erro != nil {
		respostas.Erro(w, http.StatusUnprocessableEntity, erro)
		return
	}
...
// DeletarUsuario deleta as informações no banco
...
// SeguirUsuario permite que um usuario possa seguir o outro.
...
// PararDeSeguirUsuario permite que o usuario deixe de seguir outro.
func PararDeSeguirUsuario(w http.ResponseWriter, r *http.Request) {
	...
	repositorios := repositorios.NovoRepsitorioDeUsuarios(db)
