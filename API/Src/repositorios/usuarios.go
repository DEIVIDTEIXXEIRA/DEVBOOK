...
// NovoRepositorio cria um repositorio de usuarios
func NovoRepsitorioDeUsuarios(db *sql.DB) *Usuarios {
	return &Usuarios{db}
}
...
// Deletar excui as informações de um usuario no banco de dados.
...
// PararDeSeguir permite que um usuario pare de segui o outro
...
// BuscarSeguindo traz todos os usuarios que um determinado usuário esta seguindo
